...
import type { ExternalBlob as _ExternalBlob, ProductId as _ProductId, ProductListing as _ProductListing, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createProductListing(arg0: string, arg1: string, arg2: Price, arg3: string, arg4: ExternalBlob): Promise<ProductId> {
        if (this.processError) {
            try {
                const result = await this.actor.createProductListing(arg0, arg1, arg2, arg3, await to_candid_ExternalBlob_n10(this._uploadFile, this._downloadFile, arg4));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createTransaction(arg0: Principal, arg1: Principal, arg2: Price, arg3: Price): Promise<TransactionId> {
        if (this.processError) {
            try {
    ...
    async getProductById(arg0: ProductId): Promise<ProductListing | null> {
        if (this.processError) {
            try {
    ...
    async getProductListingsSorted(arg0: string): Promise<Array<ProductListing>> {
        if (this.processError) {
            try {
                const result = await this.actor.getProductListingsSorted(arg0);
                return from_candid_vec_n11(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTotalCommission(): Promise<Price> {
        if (this.processError) {
            try {
    ...
    async productListingExists(arg0: ProductId): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.productListingExists(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async transactionExists(arg0: TransactionId): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.transactionExists(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_ProductListing_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ProductListing): Promise<ProductListing> {
...
async function from_candid_opt_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_ProductListing]): Promise<ProductListing | null> {
    return value.length === 0 ? null : await from_candid_ProductListing_n12(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_vec_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_ProductListing>): Promise<Array<ProductListing>> {
    return await Promise.all(value.map(async (x)=>await from_candid_ProductListing_n12(_uploadFile, _downloadFile, x)));
}
